...
path = '/auto/data2/eTheremin/OSCYPEK/OSCYPEK/OSCYPEK_20240723_SESSION_01/'
session_type = 'Playback'# PlaybackOnly TrackingOnly Playback
...
if session_type == 'Playback' or session_type == 'MappingChange':
